        ...
        <div class="col-sm-8 main-section ">
            <div class="modal-content ">
                <div class="col-12 user-img">
                    <img src="<?php echo base_url();?>/Chaleco/static/img/admi.png"   width="100"/>
                </div>
                <form class="col-12" action="<?php echo base_url();?>/index.php/Noticias/PrincipalAdmin" role= "form"  onsubmit="return validar();">
