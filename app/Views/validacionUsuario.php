...
<head>
    ...
    <!-- Main CSS-->
    <link href="<?php echo base_url();?>/Chaleco/static/css/main.css" rel="stylesheet" media="all">
</head>
        ...
        <div class="wrapper wrapper--w680">
            <div class="card card-4">
                <div class="card-body">
                    ...
                    <form method="POST" action="<?php echo base_url();?>/index.php/Noticias/index">
                        
                       <h1>Se ha registrado con exito</h1>
                       <a href="<?php echo base_url();?>/index.php/Noticias/PrincipalAdmin"><button class="btn btn--radius-2 btn--blue" type="submit">Regresar</button></a>
